    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if RANK in [-1, 0]:
                ...
                elif plots and ni == 3 and loggers['wandb']:
        ...
        if RANK in [-1, 0]:
            ...
            # Log
            tags = ['train/box_loss', 'train/obj_loss', 'train/cls_loss', 'train/lmk_loss', # train loss
                    'metrics/precision', 'metrics/recall', 'metrics/mAP_0.5', 'metrics/mAP_0.5:0.95',
                    'val/box_loss', 'val/obj_loss', 'val/cls_loss', 'val/lmk_loss', # val loss
