...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolov5_weights_210723/yolov5s-face.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--save_folder', default='F:/zhangqi/datasets/WIDERface/wider_test/result', type=str, help='Dir to save txt results')
    parser.add_argument('--dataset_folder', default='F:/zhangqi/datasets/WIDERface/wider_test/images/train', type=str, help='dataset path')
    parser.add_argument('--folder_pict', default='F:/zhangqi/datasets/WIDERface/wider_test/wider_val.txt', type=str, help='folder_pict')
